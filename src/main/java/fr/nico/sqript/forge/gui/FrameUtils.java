...
public final class FrameUtils {
	...
	public static Container generateTextFieldWithLabel(TextField t,int maxWidth, String label, float scale,boolean borderTest){
		...
		LabelArea l = new LabelArea(label, 0xFFFFFFFF, scale, maxWidth-t.style.getWidth()-2*t.style.bordersize);
	...
	*/
	public static ResourceLocation getImageResourceLocation(String image_name) {
		return new ResourceLocation("rpworld","gui/images/"+image_name+".png");
	...
	public static Container generateTextFieldWithLabel(TextField t,int maxWidth, String label,boolean borderTest){
		Container s= new Container(maxWidth,t.style.height);
		s.setLayout(EnumLayout.FLOW);
		LabelArea l = new LabelArea(label, 0xFFFFFFFF, 1, maxWidth-t.style.getWidth()-2*t.style.bordersize);
		l.style.setMargin(0, 5, 0, 0);
		s.addWidget(l);
		s.addWidget(t);
		if(borderTest){
	...
	*/
	...
	public static Container generateTextAreaWithLabel(TextBox t,int maxWidth, String label, boolean borderTest){
		Container s= new Container(maxWidth,t.style.height);
		s.setLayout(EnumLayout.FLOW);
		LabelArea l = new LabelArea(label, 0xFF, 1, maxWidth-t.style.getWidth()-2*t.style.bordersize);
		l.style.setMargin(0, 5, 0, 0);
		s.addWidget(l);
		s.addWidget(t);
		if(borderTest){
