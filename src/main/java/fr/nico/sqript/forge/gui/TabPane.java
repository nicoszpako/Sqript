...
public class TabPane extends Container {
	...
	private List<Button> tabsButton = new ArrayList<Button>();
	...
	@Override
	public void drawBorders(int color) {
		if (style.bordersize > 0 && style.drawborders && !containerViewOnly) {
			...
			int bheight = i * 20 - this.style.bordersize + i * 3;
			int b1height = 20 - this.style.bordersize + 3;

			drawRect(this.x+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0) - style.bordersize, this.y - style.bordersize + bheight, this.x+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0), getY2(), color);

			drawRect(this.x - style.bordersize+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0), this.y - style.bordersize, this.x+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0), this.y - style.bordersize + bheight - b1height, color);

			drawRect(this.x - style.bordersize+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0), getY2() + style.bordersize, getX2() + style.bordersize+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0), getY2(), color);
			drawRect(this.x - style.bordersize+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0), getY(), getX2() + style.bordersize+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0), getY() - style.bordersize, color);
			drawRect(getX2()+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0), getY2() + style.bordersize, getX2() + style.bordersize+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0), this.y - style.bordersize, color);
			}else{
				int i = selectedTab ;
				...
				drawRect(this.x - style.bordersize, getY(), this.x - style.bordersize+bheight, getY()-style.bordersize, color);
				drawRect(this.x - style.bordersize+bheight+tabButtonWidth, getY(), getX2(), getY()-style.bordersize, color);
			...
			if (tabs.size() > 0) {
				...
				for (int i = 0; i < tabsButton.size(); i++) {
					if (tabDisplayMode == DISPLAY_LEFT) {
						...
						b.setX(this.x - b.style.width - this.style.bordersize+(this.getTabDisplayMode()==DISPLAY_LEFT?this.tabButtonWidth/2:0));
						b.setY(this.y + i * b.style.height - this.style.bordersize + i * 3 + b.style.bordersize);
						if (i == selectedTab) {
							
							b.style.backgroundcolor = this.tabs.get(selectedTab).style.backgroundcolor;
							drawRect(b.getX2(), b.getY(), b.getX2() + b.style.bordersize, b.getY2() + b.style.bordersize,
						...
						Button b = tabsButton.get(i);
						b.setY(this.y-b.style.height-b.style.bordersize);
						if(!b.getCommand().equals("r"))b.setX(this.x+i*b.style.width+i*3);
						else b.setX(this.x+this.style.width-b.style.width);
						if (i == selectedTab) {
							b.style.backgroundcolor = this.tabs.get(selectedTab).style.backgroundcolor;
							drawRect(b.getX(), b.getY2(), b.getX2() + b.style.bordersize, b.getY2() + b.style.bordersize,
									b.style.getBackgroundcolor());
