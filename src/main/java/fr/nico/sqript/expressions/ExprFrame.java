...
import fr.nico.sqript.types.TypeButton;
...
@Expression(name = "Frame Expressions",
        features = {
                ...
                @Feature(name = "Frame image", description = "Returns a new image.", examples = "image test:gui/my_image.png", pattern = "[a[n]] [new] image [of] {resource}", type = "image", side = Side.CLIENT),
