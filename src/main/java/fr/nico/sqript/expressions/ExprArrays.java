...
@Expression(name = "Arrays",
        features = {
                ...
                @Feature(name = "Size of an array", description = "Returns the size of an array.", examples = "size of [1,4,7] #Returns 3", pattern = "size of {array}", type = "number"),
                @Feature(name = "Random element of an array", description = "Returns a random element of an array.", examples = "random element of [1,4,7]", pattern = "[a] random element of {array}"),
                @Feature(name = "First element of an array", description = "Returns the first element of an array.", examples = "first element of [1,4,7]", pattern = "[the] first element of {array}"),
                @Feature(name = "Last element of an array", description = "Returns the last element of an array.", examples = "last element of [1,4,7]", pattern = "[the] last element of {array}"),
                @Feature(name = "Element of an array", description = "Returns the element at the given index of an array. Be careful, indices start at 0.", examples = "[7,1,0,2,6][0] #Returns 7", pattern = "{!array}~[{+number}~]"),
                ...
                @Feature(name = "Element is in an array", description = "Returns whether an element is in an array.", examples = "7 is in [1,5,9,12] #Returns false", pattern = "{element} is in {array}", type = "boolean"),
                @Feature(name = "Element is not in an array", description = "Returns whether an element is not in an array.", examples = "7 is not in [1,5,9,12] #Returns true", pattern = "{element} is not in {array}", type = "boolean"),
                @Feature(name = "Array contains an element", description = "Returns whether an array contains element.", examples = "[1.5,4,5,8] contains [4,8] #Returns true", pattern = "{array} contains {element}", type = "boolean"),
                @Feature(name = "Sorted array", description = "Returns a sorted copy of an array. Elements will be sorted only if they are comparable.", examples = "sorted elements of [1,8,5] #Returns [1,5,8]", pattern = "sorted [(0;ascending)|(1;descending)] ((2;elements)|(3;keys)) of {array}", type = "array"),
